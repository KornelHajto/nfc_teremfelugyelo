...
namespace API.Migrations
{
    ...
    [Migration("20251015001604_AddExamAttendance")]
    partial class AddExamAttendance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseUser", b =>
                {
                    ...
                    b.Property<string>("StudentsNeptunId")
                        .HasColumnType("varchar(255)");

                    b.HasKey("CoursesId", "StudentsNeptunId");

                    b.HasIndex("StudentsNeptunId");
            ...
            modelBuilder.Entity("SubjectUser", b =>
                {
                    b.Property<string>("TeachersNeptunId")
                        .HasColumnType("varchar(255)");

                    b.Property<string>("TeachesId")
                        .HasColumnType("varchar(255)");

                    b.HasKey("TeachersNeptunId", "TeachesId");
            ...
            modelBuilder.Entity("CourseUser", b =>
                {
                    ...
                    b.HasOne("API.Models.User", null)
                        .WithMany()
                        .HasForeignKey("StudentsNeptunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SubjectUser", b =>
                {
                    b.HasOne("API.Models.User", null)
                        .WithMany()
                        .HasForeignKey("TeachersNeptunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
