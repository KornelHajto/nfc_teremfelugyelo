...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.User", b =>
                {
                    ...
                    b.Property<string>("PhysicalKeyKeyHash")
                        .HasColumnType("varchar(255)");

                    b.Property<string>("RememberMeRememberHash")
                        .HasColumnType("varchar(255)");
                    ...
                    b.HasIndex("PhysicalKeyKeyHash");

                    b.HasIndex("RememberMeRememberHash");
            ...
            modelBuilder.Entity("API.Models.User", b =>
                {
                    b.HasOne("API.Models.Key", "PhysicalKey")
                        .WithMany()
                        .HasForeignKey("PhysicalKeyKeyHash");

                    b.HasOne("API.Models.RememberMe", "RememberMe")
                        .WithMany()
                        .HasForeignKey("RememberMeRememberHash");

                    b.HasOne("API.Models.Subject", null)
                        .WithMany("Teachers")
                        .HasForeignKey("SubjectId");

                    b.Navigation("PhysicalKey");
